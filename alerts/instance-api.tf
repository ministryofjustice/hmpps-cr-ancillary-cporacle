...
resource "aws_cloudwatch_metric_alarm" "CPUUtilization_critical" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_CPUUtilization--critical"
...
resource "aws_cloudwatch_metric_alarm" "CPUUtilization_warning" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_CPUUtilization--warning"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 2
  metric_name         = "CPUUtilization"
  namespace           = "AWS/EC2"
...
resource "aws_cloudwatch_metric_alarm" "StatusCheckFailed" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_StatusCheckFailed--critical"
  comparison_operator = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "MemoryUtilization_critical" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_MemoryUtilization--critical"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
...
resource "aws_cloudwatch_metric_alarm" "MemoryUtilization_warning" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_MemoryUtilization--warning"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = 1
  metric_name         = "MemoryUtilization"
  namespace           = "CWAgent"
...
resource "aws_cloudwatch_metric_alarm" "free_disk_space_C_critical" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_Free_Space_C_Drive--critical"
...
resource "aws_cloudwatch_metric_alarm" "free_disk_space_C_warning" {
  alarm_name          = "${local.common_name}_CPOracle_API_Instance_Free_Space_C_Drive--warning"
  comparison_operator = "LessThanThreshold"
  evaluation_periods  = 1
  metric_name         = "LogicalDisk % Free Space"
  namespace           = "CWAgent"
