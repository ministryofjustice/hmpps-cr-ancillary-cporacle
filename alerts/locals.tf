locals {
  ...
  app_aws_route53_record_name = data.terraform_remote_state.alb.aws_route53_record_cporacle["name"]
  api_aws_route53_record_name = data.terraform_remote_state.alb.aws_route53_record_cporacle_api["name"]
}
