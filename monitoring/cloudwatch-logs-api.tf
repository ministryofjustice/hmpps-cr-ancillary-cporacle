...
resource "aws_cloudwatch_metric_alarm" "cporacle_api_cloudwatch_agent_log_warning" {
  alarm_name                = "${var.environment_name}-cporacle_api-cloudwatch_agent_log--warning"
  comparison_operator       = "LessThanThreshold"
  period                    = "60"
  evaluation_periods        = "5"
  metric_name               = local.cporacle_api_cloudwatch_agent_log_sum_metric_name
  namespace                 = "cporacle_api"
  statistic                 = "Sum"
  threshold                 = "1"
...
resource "aws_cloudwatch_metric_alarm" "cporacle_api_cloudwatch_agent_log_critical" {
  alarm_name                = "${var.environment_name}-cporacle_api-cloudwatch_agent_log--critical"
  comparison_operator       = "LessThanThreshold"
  period                    = "60"
